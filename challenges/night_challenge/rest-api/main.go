...
import (
	...
	"github.com/pucsd2020-pp/challenges/night_challenge/rest-api/config"
	...
	httpHandler "github.com/pucsd2020-pp/challenges/night_challenge/rest-api/handler/http"
)
...
func init() {
	...
	handlers = []handler.IHTTPHandler{
		httpHandler.NewProjectHandler(dbConn),
	}
}
